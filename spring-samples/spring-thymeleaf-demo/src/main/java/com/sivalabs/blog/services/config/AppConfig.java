 ...
 * 
 */
package com.sivalabs.blog.services.config;
 ...
 */
@Configuration
@ComponentScan(value="com.sivalabs.blog", 
	excludeFilters = @Filter(type = FilterType.CUSTOM, value = { WebPackageFilter.class }))
@PropertySource("classpath:application.properties")
@EnableTransactionManagement
@EnableJpaRepositories("com.sivalabs.blog.repositories")
...
class WebPackageFilter extends RegexPatternTypeFilter
{
    public WebPackageFilter() {
        super(Pattern.compile("com\\.sivalabs\\.blog\\.web\\..*"));
    }
}
