package com.sivalabs.pfdemo.controllers;
...
import com.sivalabs.pfdemo.model.User;
...
public class UserController 
{
	...
	public String login() 
	{
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, loginStatus, loginStatus));
		return null;
	}
